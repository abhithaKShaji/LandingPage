    ...
    <div className='w-full md:w-1/3 bg-white border-2 border-lightText md:border-none p-5 rounded-lg hover:shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition-all'>
      <div>
        <p className=" text-lightText">Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
            Inventore fugit minus, quasi consectetur repellendus ipsum ratione porro ipsa, praesentium, molestiae tempora quae quos possimus alias ea eveniet quidem quam exercitationem.</p>
      </div>
